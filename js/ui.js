...
export async function buildNav(activePage = '') {
  ...
  drawer.innerHTML = `
    ...
    <nav class="drawer-nav">
      ...
      <button class="drawer-link" id="drawer-logout" style="width:100%;text-align:left;background:none;border:none;cursor:pointer;color:var(--red);"><span class="drawer-link-icon">↪️</span> Logout</button>
      ` : `
      <div class="drawer-divider" style="margin:8px 0;"></div>
      <a href="login.html"  class="drawer-link"><span class="drawer-link-icon">🔑</span> Log In</a>
      <a href="signup.html" class="drawer-link" style="color:var(--green);"><span class="drawer-link-icon">🎓</span> Create Account</a>
      `}
    </nav>
  `
